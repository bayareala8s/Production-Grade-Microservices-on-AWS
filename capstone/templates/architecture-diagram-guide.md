...
- **Sequence:** [08-sequence-place-order.md](../../docs/diagrams/08-sequence-place-order.md) (e-commerce) or scan → analyze → recommend for Option 4
- **Events:** [09-event-driven-flow.md](../../docs/diagrams/09-event-driven-flow.md)
- **Option 4 decomposition:** [option-4-idle-cost-decomposition.md](option-4-idle-cost-decomposition.md)
